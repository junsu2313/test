...
## Compile DslrDashboard Server on OpenWrt
 ...
 Under **Multimedia** select **ddserver**. Build OpenWrt or just a single package. The resulting package will appear under the OpenWrt package output directory for the current package version. If you selected * the package will be already installed in the OpenWrt image.
